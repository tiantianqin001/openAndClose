package com.telit.money.start.customview;

/**
 * *****************************************************************
 * author: Administrator
 * time: 2021/1/14 14:18
 * name;
 * overview:
 * usage:
 * ******************************************************************
...
import com.telit.money.start.utils.UnreadMsgUtils;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setViewPager(ViewPager vp, String[] titles, AppCompatActivity fa, List<Fragment> fragments) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
    ...
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        ...
        this.mViewPager = vp;
        this.mViewPager.setAdapter(new SlidingTabLayout.InnerPagerAdapter(fa.getSupportFragmentManager(), fragments, titles));
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_SP, i == mCurrentTab ? mTextSelectSize : mTextUnSelectSize);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(isSelect ? mTextSelectSize : mTextUnSelectSize);
